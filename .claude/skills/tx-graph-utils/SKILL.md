---
name: "tx-graph-utils"
description: "Inspect graph anchors plus supporting utility and usage commands. Use when working in Claude Code and the user needs tx commands from this area."
metadata:
