...
description: "Configure gates, guards, labels, verification, and retrospectives for bounded autonomy. Use when working in Claude Code and the user needs tx commands from this area."
metadata:
