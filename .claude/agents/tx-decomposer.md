...
3. Read relevant source files and design docs
4. Break the task into subtasks
5. Create subtasks: `tx add "<title>" --parent <id> --score <n>`
6. Set up dependencies: `tx block <blocked> <blocker>`
7. Mark the parent as planned: `tx update <id> --status planning`
