...
describe("TxClient", () => {
  ...
  describe("namespaces", () => {
    ...
    it("exposes spec namespace", () => {
      ...
      expect(typeof client.spec.discover).toBe("function")
      expect(typeof client.spec.link).toBe("function")
      expect(typeof client.spec.unlink).toBe("function")
      expect(typeof client.spec.tests).toBe("function")
      expect(typeof client.spec.invariantsForTest).toBe("function")
      expect(typeof client.spec.gaps).toBe("function")
      expect(typeof client.spec.fci).toBe("function")
      expect(typeof client.spec.matrix).toBe("function")
      expect(typeof client.spec.status).toBe("function")
      expect(typeof client.spec.run).toBe("function")
      expect(typeof client.spec.batch).toBe("function")
      expect(typeof client.spec.complete).toBe("function")
    })
  })
})
