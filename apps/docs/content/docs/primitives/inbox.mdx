...
<Mermaid
  ...
  chart={`sequenceDiagram
    ...
    Planner->>TX: tx send team "review this"
    A->>TX: tx inbox team --after 0
    TX-->>A: pending message
    B->>TX: tx inbox team --after 0
...
<Mermaid
  ...
  chart={`stateDiagram-v2
    [*] --> Pending: tx send
    Pending --> Pending: tx inbox / cursor read
    Pending --> Acked: tx ack / tx ack:all
