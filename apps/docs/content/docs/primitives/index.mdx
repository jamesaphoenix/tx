---
title: CLI Primitives
description: Core CLI commands for task management in tx
---
...
| [`tx claim`](/docs/primitives/claim) | Mark task as being worked by an agent | Planned |
| [`tx handoff`](/docs/primitives/handoff) | Transfer task with context to another agent | Planned |
| [`tx checkpoint`](/docs/primitives/checkpoint) | Save progress without completing | Planned |
