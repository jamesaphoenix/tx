...
<Mermaid
  ...
  chart={`flowchart TB
    Docs["A. Docs and invariants<br/>tx docs<br/>tx invariant sync"]
    Tests["B. Test sources<br/>tags<br/>.tx/spec-tests.yml"]
    Map["1. Traceability mappings<br/>discover<br/>link<br/>canonical IDs"]
    Runs["2. Recorded outcomes<br/>tx spec run<br/>tx spec batch"]
    Phase["3. FCI and phase<br/>BUILD<br/>HARDEN<br/>COMPLETE"]
...
<Mermaid
  ...
  chart={`flowchart TB
    Build["BUILD<br/>FCI < 100<br/>automatic"]
    Harden["HARDEN<br/>FCI = 100<br/>automatic"]
    Complete["COMPLETE<br/>human sign-off<br/>manual"]

    Build -->|"FCI reaches 100"| Harden
    Harden -->|"tx spec complete --by human"| Complete
    Harden -. "failing outcome" .-> Build
  `}
/>
