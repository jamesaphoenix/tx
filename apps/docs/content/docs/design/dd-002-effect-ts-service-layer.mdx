...
description: "This document describes how the Effect-TS service layer is architected: service definitions, layer composition, error handling, and repository patterns."
---


**Status**: Draft
**Implements**: [PRD-001](/docs/prd/prd-001-core-task-management), [PRD-003](/docs/prd/prd-003-dependency-blocking-system)
...
- [DD-001: Data Model & Storage](/docs/design/dd-001-data-model-storage)
- [DD-003: CLI Implementation](/docs/design/dd-003-cli-implementation)
- [DD-004: Ready Detection Algorithm](/docs/design/dd-004-ready-detection-algorithm)
