...
description: "This design document describes how to implement the graph schema, edge storage, anchor verification, and symbol extraction defined in PRD-014."
---
