...
description: "This document describes how tx integrates with Claude Code (via MCP) and the Anthropic Agent SDK. All tools return TaskWithDeps with full dependency information."
---
