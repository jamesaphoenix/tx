...
description: "This document describes how tx stores and structures data: SQLite schema design, Effect Schema type definitions, ID generation strategy, and data access patterns."
---


**Status**: Draft
**Implements**: [PRD-001](/docs/prd/prd-001-core-task-management), [PRD-002](/docs/prd/prd-002-hierarchical-task-structure)
...
└── .tx/
    ...
    ├── config.toml     # Project configuration (created by tx init)
...
- [PRD-002: Hierarchical Task Structure](/docs/prd/prd-002-hierarchical-task-structure)
