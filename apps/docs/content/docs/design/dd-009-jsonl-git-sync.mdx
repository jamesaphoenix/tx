...
description: "This document describes the implementation of bidirectional JSONL sync for git-based task distribution across machines and teams."
---
...
# DO NOT ignore: .tx/config.toml (project settings)
```
