...
description: "This document describes how tx integrates with Claude for LLM-powered features: deduplication, compaction, and learnings export to CLAUDE.md."
---


**Status**: Draft
**Implements**: [PRD-005](/docs/prd/prd-005-llm-deduplication), [PRD-006](/docs/prd/prd-006-task-compaction-learnings)
...
- [PRD-005: LLM-Powered Deduplication](/docs/prd/prd-005-llm-deduplication)
- [PRD-006: Task Compaction & Learnings](/docs/prd/prd-006-task-compaction-learnings)
