...
description: "Explicit dependency graphs where tasks can block other tasks, with automatic ready detection"
---
...
- [PRD-004: Task Scoring & Prioritization](/docs/prd/prd-004-task-scoring-prioritization)
