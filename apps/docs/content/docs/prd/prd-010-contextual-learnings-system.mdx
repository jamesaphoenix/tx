...
description: "Dynamic task-specific retrieval of learnings using hybrid search with BM25 and vector embeddings"
---
...
| CL-003 | List recent learnings | `tx memory list --sort recent [-n limit]` |
...
- [PRD-006: Task Compaction & Learnings](/docs/prd/prd-006-task-compaction-learnings) - Original learnings export
- [PRD-011: Claude Code Hooks Integration](/docs/prd/prd-011-claude-code-hooks) - Hook-based injection
