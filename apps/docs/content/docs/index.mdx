...
If you need generated agent bundles or manual long-running task loops, add
[`tx skills`](/docs/primitives/skills) and [Ralph Loop](/docs/ralph-loop) after
Getting Started.
...
- **Task Management**: [`tx ready`](/docs/primitives/ready), [`tx done`](/docs/primitives/done), [`tx dep block`](/docs/primitives/block), [`tx sync`](/docs/primitives/sync)
...
- **Bounded Autonomy**: [`tx auto label`](/docs/primitives/label), [`tx auto guard`](/docs/primitives/guard), [`tx auto verify`](/docs/primitives/verify), [`tx auto reflect`](/docs/primitives/reflect), [`tx auto gate`](/docs/primitives/gate)
- **Coordination**: [`tx claim`](/docs/primitives/claim), [`tx msg inbox`](/docs/primitives/inbox), task-group context
