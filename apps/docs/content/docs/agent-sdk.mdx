...
Spec traceability primitives bridge docs, invariants, tests, and FCI.

#### `tx.spec.discover(options?)`

Sync invariants from docs and discover mappings from tags, comments, and manifest entries.
...
Get current FCI phase and uncovered-gap count.
