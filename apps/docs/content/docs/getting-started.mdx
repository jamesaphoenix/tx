...
Get up and running with tx in minutes. tx provides four interfaces. Pick the one that fits your workflow.
...
1. **[Primitives](/docs/primitives)** learn the core building blocks (`ready`, `done`, `block`, `memory`, `sync`).
