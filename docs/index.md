...
## Requirements Documents (REQs)

REQ docs are maintained as markdown convention files under `docs/requirements/` (not generated by `tx doc add`).
...
SD docs are maintained as markdown convention files under `docs/system-design/` (not generated by `tx doc add`).
